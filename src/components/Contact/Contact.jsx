        ...
        <>
            <div className='contact' data-aos="fade-right">
                <div className='card' data-aos="fade-right">
                    ...
                    <p data-aos="fade-right" data-aos-duration="500" className="info">bruno.trindadefm@gmail.com</p>
                    ...
                    <p data-aos="fade-right" data-aos-duration="500" className='info'>Cruzeiro</p>
                    <p data-aos="fade-right" data-aos-duration="500" className='info'>Rua Maceió</p>
